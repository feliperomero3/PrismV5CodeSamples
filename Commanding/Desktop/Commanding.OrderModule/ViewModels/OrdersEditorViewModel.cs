...
namespace Commanding.Modules.Order.ViewModels
{
    /// <summary>
    ...
    public class OrdersEditorViewModel : INotifyPropertyChanged
    {
        ...
        {
            Debug.WriteLine("Processing order {0} with parameter {1}.", SelectedOrder.OrderName, parameter);
        }
        ...
        private void PopulateOrders()
        {
            ...
            foreach (Services.Order order in _ordersRepository.GetOrdersToEdit())
            {
                ...
                _commandProxy.SaveAllOrdersCommand.RegisterCommand(orderPresentationModel.SaveOrderCommand);
            }
        }
        ...
        private void OrderSaved(object sender, DataEventArgs<OrderViewModel> e)
        {
            if (e != null && e.Value != null)
            {
                ...
                if (this.Orders.Contains(order))
                {
                    ...
                    this._commandProxy.SaveAllOrdersCommand.UnregisterCommand(order.SaveOrderCommand);
